  ...
  const users = [
    {
      id: '1',
      name: 'Vinesa Sawyer',
      email: 'vinesa.sawyer@bahfsa.gov.bs',
      phone: '(242) 555-0123',
      role: 'inspector',
      status: 'active',
    ...
    },
    {
      ...
      email: 'ezra.bartholomew@bahfsa.gov.bs',
      phone: '(242) 555-0456',
      role: 'inspector',
      status: 'active',
    ...
    },
    {
      id: '3',
      name: 'Yasmin Johnson',
      email: 'yasmin.johnson@bahfsa.gov.bs',
      phone: '(242) 555-0789',
      role: 'supervisor',
      status: 'active',
      lastLogin: '2025-01-20',
    ...
    },
    {
      id: '4',
      name: 'Tamico Nelson',
      email: 'tamico.nelson@bahfsa.gov.bs',
      phone: '(242) 555-0321',
      role: 'inspector',
      status: 'inactive',
    ...
    },
    {
      ...
      email: 'sarah.mitchell@bahfsa.gov.bs',
      phone: '(242) 555-0654',
      role: 'lab_technician',
      status: 'active',
