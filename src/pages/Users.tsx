...
const Users: React.FC = () => {
  ...
  const users = [
    {
      id: '1',
      name: 'Vinesa Sawyer',
      email: 'vinesasawyer@bahfsa.gov.bs',
      phone: '(242) 555-0123',
      role: 'inspector',
      status: 'active',
    ...
    },
    {
      ...
      email: 'ezrabartholomew@bahfsa.gov.bs',
      phone: '(242) 555-0456',
      role: 'coordinator',
      status: 'active',
    ...
    },
    {
      id: '3',
      name: 'Yasmin Johnson',
      email: 'yasminjohnson@bahfsa.gov.bs',
      phone: '(242) 555-0789',
      role: 'director',
      status: 'active',
      lastLogin: '2025-01-20',
    ...
    },
    {
      id: '4',
      name: 'Tamico Nelson',
      email: 'tamiconelson@bahfsa.gov.bs',
      phone: '(242) 555-0321',
      role: 'coordinator',
      status: 'inactive',
    ...
    },
    {
      id: '5',
      name: 'Sarah Johnson',
      email: 'sarahjohnson@bahfsa.gov.bs',
      phone: '(242) 555-0654',
      role: 'lab_technician',
      status: 'active',
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      ...
      case 'director':
        return <Badge variant="danger">Director</Badge>;
         case 'coordinator':
